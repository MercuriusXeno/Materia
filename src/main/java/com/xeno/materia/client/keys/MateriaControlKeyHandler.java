...
public class MateriaControlKeyHandler
{
     ...
     */
    public static void handleMouseEventGenerally(InputEvent.MouseButton.Post eventMouseButton)
    {
        // NOOP, I was doing something here and now I'm not.
    }

    public static void handleMouseEventOnScreens(ScreenEvent.MouseButtonPressed.Post eventMouseButton)
    {
        // NOOP, I was doing something here and now I'm not.
    }

    public static void handleKeyEventOnScreens(ScreenEvent.KeyPressed.Post pressedKeyEvent)
    {
    ...
    private static void givePlayerMateria(Player p, CompoundInstance eq)
    {
        ...
        {
            MateriaRegistry.typeOf(eq).changeMateria(p, eq.getAmount().longValue());
        }
    }
