...
public class RadialMenu<T> {
	...
	private final IDrawCallback<T> drawCallback;
	 ...
	 */
	public RadialMenu(IntConsumer setSelectedSlot, List<RadialMenuSlot<T>> radialMenuSlots, IDrawCallback<T> drawCallback, int offset) {
	 ...
	 * @param offset          Additional offset amount for secondary icons. If your Icons don't above each other try around with this parameter
	 */
	public RadialMenu(IntConsumer setSelectedSlot, List<RadialMenuSlot<T>> radialMenuSlots, SecondaryIconPosition secondaryIconStartingPosition, IDrawCallback<T> drawCallback, int offset) {
		this.setSelectedSlot = setSelectedSlot;
		this.radialMenuSlots = radialMenuSlots;
	...
	public void drawIcon(T objectToBeDrawn, GuiGraphics poseStack, int positionX, int positionY, int size) {
		this.drawCallback.accept(objectToBeDrawn, poseStack, positionX, positionY, size, true);
	}
