...
public class RenderUtils {
	...
	public static void drawItemAsIcon(MateriaSlotData slotData, GuiGraphics graphics, int positionX, int positionY, int size, boolean renderTransparent) {
		renderFakeItemTransparent(graphics.pose(), slotData.representative(), positionX, positionY, size, 0, renderTransparent,150);
	}
