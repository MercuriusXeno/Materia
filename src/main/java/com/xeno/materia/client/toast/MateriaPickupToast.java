...
public class MateriaPickupToast implements Toast
{
    ...
    public Visibility render(GuiGraphics guiGraphics, ToastComponent toastComponent, long timeSinceLastVisible) {
        ...
        // stretch the middle
        guiGraphics.blit(type.texture(), 0, 0, 0, 32, this.width(), 8);
        ...
        for (var middleY = 0; middleY < middleHeight; middleY += 16) {
            ...
            guiGraphics.blit(type.texture(), 0, 8 + middleY, 0, 32 + 8, this.width(), tileHeight);
        }
        guiGraphics.blit(type.texture(), 0, height - 8, 0, 32 + 32 - 8, this.width(), 8);
        var lineY = 18;
